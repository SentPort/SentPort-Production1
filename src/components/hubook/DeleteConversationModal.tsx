          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-start gap-3">
                <EyeOff className="w-5 h-5 text-gray-600 group-hover:text-blue-600 mt-0.5" />
                <div className="flex-1">
                  <h4 className="font-medium text-gray-900 group-hover:text-blue-900">Hide Conversation</h4>
                  <p className="text-sm text-gray-600 mt-1">
                    Remove from your messages list. If they send you a new message, the conversation will reappear.
                  </p>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex items-start gap-3">
                <Ban className="w-5 h-5 text-gray-600 group-hover:text-red-600 mt-0.5" />
                <div className="flex-1">
