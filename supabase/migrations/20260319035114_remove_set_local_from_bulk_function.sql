/*
  # Remove SET LOCAL from bulk_add_content_type_rules

  ## Problem
  SET LOCAL row_security = off requires superuser privileges and fails.
  Need to rely on RLS policies instead.

  ## Solution
  Remove the SET LOCAL command and rely on the new policy added earlier.
*/
